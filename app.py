...
st.set_page_config(page_title="SkillSense", layout="wide")
...
if not st.session_state.auth_status:
    ...
    with col2:
        ...
        st.markdown(
            "<h1 style='text-align:center;'>SkillSense</h1>",
...
# ---------------- MAIN APP ----------------
    ...
    page = st.sidebar.radio(
        "Navigation",
        ["Framework Generator", "Assessment History"],
    )
...
""",
            ...
            elements = [
                Paragraph("SKILLSENSE – HR ASSESSMENT REPORT", styles["Title"]),
                Spacer(1, 20),
